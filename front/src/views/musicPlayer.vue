<template>
  <div class="musicPlayer" v-if="theUrl">
    ...
    <div>
      ...
      <el-button
        ...
        v-if="audio.playing"
        ><img src="../assets/toolLogo/暂停1.png" style="width: 25px" />
      </el-button>
      <el-button
        class="play-button"
        type="text"
        @click="startPlayOrPause"
        v-if="!audio.playing"
        ><img src="../assets/toolLogo/播放2.png" style="width: 25px" />
      </el-button>
      <!--      <el-button-->
      ...
      <el-tag class="currentTime" type="info">{{
      ...
      <el-button
        ...
        @click="startMutedOrNot"
        v-if="audio.muted"
        ><img src="../assets/toolLogo/音量2.png" style="width: 25px"
      /></el-button>
      <el-button
        v-show="!controlList.noMuted"
        class="vol-button"
        ...
        v-if="!audio.muted"
        @click="startMutedOrNot"
        ><img src="../assets/toolLogo/静音2.png" style="width: 25px"
      /></el-button>
      ...
      <a
        ...
        class="download"
        download
        ><img src="../assets/toolLogo/下载2.png" style="width: 30px"
      /></a>
    </div>
  </div>
</template>
